# Chapter 4-8 Weighted Sum：AttnWeights @ V
...
- 输入来源：MatMul
- 学习目标：汇聚 value
- 后续用途：attention output

## 2. 当前案例

AttnWeights @ V 把「MatMul」变成可复用的图组件。

任务不是背公式，而是处理一个具体图案例：把准备好的案例数据通过 AttnWeights @ V 连接到合约探针。
